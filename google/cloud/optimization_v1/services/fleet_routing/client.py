...
class FleetRoutingClientMeta(type):
    """Metaclass for the FleetRouting client.
...
class FleetRoutingClient(metaclass=FleetRoutingClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            FleetRoutingClient: The constructed client.
        """
    ...
    def transport(self) -> FleetRoutingTransport:
        ...
        Returns:
            FleetRoutingTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(transport, FleetRoutingTransport):
            # transport is a FleetRoutingTransport instance.
    ...
    def optimize_tours(
        ...
        *,
        ...
        # in a fleet_routing.OptimizeToursRequest.
    ...
    def batch_optimize_tours(
        ...
        *,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a fleet_routing.BatchOptimizeToursRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
