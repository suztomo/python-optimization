...
class FleetRoutingGrpcAsyncIOTransport(FleetRoutingTransport):
    """gRPC AsyncIO backend transport for FleetRouting.
    ...
    def optimize_tours(
        ...
        Awaitable[fleet_routing.OptimizeToursResponse],
    ]:
        ...
        if "optimize_tours" not in self._stubs:
            self._stubs["optimize_tours"] = self.grpc_channel.unary_unary(
                ...
                request_serializer=fleet_routing.OptimizeToursRequest.serialize,
                response_deserializer=fleet_routing.OptimizeToursResponse.deserialize,
            )
    ...
    def batch_optimize_tours(
        ...
        [fleet_routing.BatchOptimizeToursRequest], Awaitable[operations_pb2.Operation]
    ]:
        ...
        if "batch_optimize_tours" not in self._stubs:
            self._stubs["batch_optimize_tours"] = self.grpc_channel.unary_unary(
                ...
                request_serializer=fleet_routing.BatchOptimizeToursRequest.serialize,
