...
class FleetRoutingRestInterceptor:
    """Interceptor for FleetRouting.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the FleetRoutingRestTransport.

    .. code-block:: python
        class MyCustomFleetRoutingInterceptor(FleetRoutingRestInterceptor):
        ...
        transport = FleetRoutingRestTransport(interceptor=MyCustomFleetRoutingInterceptor())
    ...
    def pre_batch_optimize_tours(
        ...
        before they are sent to the FleetRouting server.
        """
        return request, metadata
...
class FleetRoutingRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: FleetRoutingRestInterceptor


class FleetRoutingRestTransport(FleetRoutingTransport):
    """REST backend transport for FleetRouting.
    ...
    def __init__(
        ...
        *,
        ...
        self._interceptor = interceptor or FleetRoutingRestInterceptor()
    ...
    class _BatchOptimizeTours(FleetRoutingRestStub):
        def __hash__(self):
    ...
    class _OptimizeTours(FleetRoutingRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = fleet_routing.OptimizeToursResponse()
